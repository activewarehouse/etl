h1. ETL (Formerly, ActiveWarehouse-ETL)

Note: This project is a work in progress: gradual modernization of activewarehouse-etl.

ETL is a Ruby Extract-Transform-Load (ETL) tool.
